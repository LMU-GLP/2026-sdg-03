...
5. GitHub asks whether Claude can access your account. Press the green
   **Authorize** button
6. Back in the repo list, search for `2026-sdg-03` and click
   **LMU-GLP/2026-sdg-03**

**Repo not in the list?** You haven't accepted the invitation to it yet. Open
**[github.com/LMU-GLP/2026-sdg-03/invitations](https://github.com/LMU-GLP/2026-sdg-03/invitations)**
...
[github.com/LMU-GLP/2026-sdg-03](https://github.com/LMU-GLP/2026-sdg-03).
...
```
Set up this repo as an LLM wiki for our challenge: "How might we support young people's mental health through a simple product, service, or community program?"
...
https://sdgs.un.org/goals/goal3, one dataset with real figures, and one
...
[your repo](https://github.com/LMU-GLP/2026-sdg-03) and click the
**Pull requests** tab.
...
**[github.com/LMU-GLP/2026-sdg-03/tree/main/wiki](https://github.com/LMU-GLP/2026-sdg-03/tree/main/wiki)**
...
**https://lmu-glp.github.io/2026-sdg-03/**
...
[your repo](https://github.com/LMU-GLP/2026-sdg-03) → **Pull requests** tab.
